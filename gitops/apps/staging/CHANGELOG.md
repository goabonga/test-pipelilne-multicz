...
What has actually been promoted to `staging`. Bumped by the workflow that
moves the pins, and tagged `gitops-staging-v<version>`.
...
### Upstream: gitops (v∅ → v0.3.0)

- - feat(gitops): flux layout with pinned staging and production (799dccf)
- - feat(gitops): promotion workflows for staging and production (745a6b6)

### Upstream: chart-api (v∅ → v3.0.0)
...
### Upstream: chart-migrations (v∅ → v0.3.0)
...
### Upstream: gitops (v∅ → v0.2.0)

- - feat(gitops): flux layout with pinned staging and production (799dccf)
- - feat(gitops): promotion workflows for staging and production (745a6b6)

### Upstream: chart-api (v∅ → v2.0.0)
...
### Upstream: chart-migrations (v∅ → v0.2.0)
...
### Upstream: gitops (v∅ → v0.1.0)

- - feat(gitops): flux layout with pinned staging and production (799dccf)
- - feat(gitops): promotion workflows for staging and production (745a6b6)

### Upstream: chart-api (v∅ → v1.0.0)
...
### Upstream: chart-migrations (v∅ → v0.1.0)
