...
//
// Build the shomer-web frontend assets and sync them into the
// downstream Python package. Outputs land directly under
// packages/web/src/shomer_web/{static,templates}/ — that's the only
...
// dev who edits packages/web/src/shomer_web/templates/login.html
// directly knows to fix it upstream in web-frontend instead.
...
const OUT_STATIC = resolve(ROOT, "..", "web", "src", "shomer_web", "static");
const OUT_TEMPLATES = resolve(ROOT, "..", "web", "src", "shomer_web", "templates");

const AUTO_GEN_COMMENT_HTML = (sourcePath) =>
  `<!-- AUTO-GENERATED from packages/web-frontend/src/templates/${sourcePath} - DO NOT EDIT -->\n`;
