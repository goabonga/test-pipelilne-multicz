...
- **gitops-staging** minor — 0.2.0 → 0.3.0
...
- **gitops-production** minor — 0.1.0 → 0.2.0
...
- **api** minor — 0.2.0 → 0.3.0  _(cascade from database 0.3.0)_
- **app** minor — 0.2.0 → 0.3.0  _(cascade from lib 0.3.0)_
- **chart-api** major — 2.0.0 → 3.0.0  _(cascade from api 0.3.0)_
- **chart-job** major — 2.0.0 → 3.0.0  _(cascade from job 3.0.0)_
- **chart-migrations** minor — 0.2.0 → 0.3.0  _(cascade from migrations 0.3.0)_
- **chart-ssr** major — 2.0.0 → 3.0.0  _(cascade from ssr 3.0.0)_
- **cli** minor — 0.2.0 → 0.3.0
- **database** minor — 0.2.0 → 0.3.0
- **docs** major — 2.0.0 → 3.0.0  _(cascade from api 0.3.0)_
- **gitops** minor — 0.2.0 → 0.3.0
- **infra** minor — 0.2.0 → 0.3.0
- **infra-modules-example** minor — 0.2.0 → 0.3.0
- **job** major — 2.0.0 → 3.0.0  _(cascade from database 0.3.0)_
- **lib** minor — 0.2.0 → 0.3.0
- **migrations** minor — 0.2.0 → 0.3.0  _(cascade from database 0.3.0)_
- **ssr** major — 2.0.0 → 3.0.0  _(cascade from web 3.0.0)_
- **web** major — 2.0.0 → 3.0.0  _(cascade from lib 0.3.0)_
...
- **docs**: reset the configs versions no apply ever produced (`5950f5d`)
...
- **chart-job** major — 1.0.0 → 2.0.0  _(cascade from job 2.0.0)_
- **chart-migrations** minor — 0.1.0 → 0.2.0  _(cascade from migrations 0.2.0)_
- **chart-ssr** major — 1.0.0 → 2.0.0  _(cascade from ssr 2.0.0)_
- **cli** minor — 0.1.0 → 0.2.0
- **database** minor — 0.1.0 → 0.2.0
- **docs** major — 1.0.1 → 2.0.0  _(cascade from api 0.2.0)_
- **gitops** minor — 0.1.0 → 0.2.0
- **infra** minor — 0.1.0 → 0.2.0
- **infra-modules-example** minor — 0.1.0 → 0.2.0
- **job** major — 1.0.0 → 2.0.0  _(cascade from database 0.2.0)_
- **lib** minor — 0.1.0 → 0.2.0
- **migrations** minor — 0.1.0 → 0.2.0  _(cascade from database 0.2.0)_
- **ssr** major — 1.0.0 → 2.0.0  _(cascade from web 2.0.0)_
- **web** major — 1.0.0 → 2.0.0  _(cascade from lib 0.2.0)_
